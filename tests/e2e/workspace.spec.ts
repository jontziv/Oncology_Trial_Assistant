  ...
  await page.route("**/v1/analyses/demo/results", async (route) => {
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        timeline: {
          label: "Enrollment-adjusted study timeline proxy",
          median_months: 28,
          q1_months: 22,
          q3_months: 34,
          median_enrollment: 84,
          median_participants_per_month: 3,
          target_enrollment: 80,
          projected_enrollment_months: 26.7,
          throughput_cohort_size: 10,
          cohort_size: 12,
          excluded_count: 3,
          confidence: 0.7,
